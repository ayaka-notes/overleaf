...
To avoid manual updates with `bin/up` your instance everytime, you can automate updates to your TeX Live image. See [updating-tex-live-full-images-automatically.md](../../maintenance/updating-tex-live-full-images-automatically.md "mention").
