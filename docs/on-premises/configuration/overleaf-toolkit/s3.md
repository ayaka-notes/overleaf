...
{% hint style="info" %}
This document covers the setup of S3 in Server CE and CEP. A [separate guide](../../maintenance/s3-migration.md) can be found on migrating existing data to S3 compatible storage.
{% endhint %}
