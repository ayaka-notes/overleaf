...
# S3(need modification)

{% hint style="info" %}
This document covers the setup of S3 in Server CE and Server Pro. A [separate guide](../../maintenance/s3-migration.md) can be found on migrating existing data to S3 compatible storage.
{% endhint %}
...
### S3 compatible object storage options <a href="#s3-compatible-object-storage-options" id="s3-compatible-object-storage-options"></a>
...
### Latency considerations when picking a S3 compatible object storage <a href="#latency-considerations-when-picking-a-s3-compatible-object-storage" id="latency-considerations-when-picking-a-s3-compatible-object-storage"></a>
