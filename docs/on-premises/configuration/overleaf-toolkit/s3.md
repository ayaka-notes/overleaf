...
{% hint style="info" %}
This document covers the setup of S3 in Server CE and Ayakaleaf Pro. A [separate guide](../../maintenance/s3-migration.md) can be found on migrating existing data to S3 compatible storage.
{% endhint %}

{% hint style="warning" %}
If you deploy Ayakaleaf Pro with [s3.md](s3.md "mention") storage enabled, is the data stored in S3 encrypted?
