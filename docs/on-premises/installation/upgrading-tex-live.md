...
{% hint style="warning" %}
The following instructions **only** apply to Community Edition installations. We highly recommend that Overleaf Pro users enable [Sandboxed Compiles](/broken/pages/7f495e34c7e239040c704060deafb9c9858aca72) as this provides users with access to the same TeX Live images used on [overleaf.com](../configuration/overleaf-toolkit/) as well as providing isolation between project compiles for enhanced security.
{% endhint %}
