...
The Toolkit is the recommended way to deploy and manage Overleaf Server CE and CEP, also server Pro instances.
...
For more details, see the [Toolkit repository](https://github.com/overleaf/toolkit) on GitHub.
