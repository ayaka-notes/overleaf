...
{% hint style="info" %}
[ayaka-notes/overleaf-toolkit](https://github.com/ayaka-notes/toolkit) is modified to use overleaf-pro image from ghcr directly. Also with texlive provided by ayaka-notes. But you can download official overleaf-toolkit.
{% endhint %}
