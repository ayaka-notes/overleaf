...
For example, to set the `mongo` service image, rather than editing `lib/docker-compose.mongo.yml` directly, set the image using the environment variable `MONGO_IMAGE` in `config/overleaf.rc`. For more information see the [Toolkit settings](/broken/pages/21166f71d6ba0aaaf1e8e2a6560e7fdb8342f01e) page.
{% endhint %}
