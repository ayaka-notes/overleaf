...
{% hint style="info" %}
This document covers the setup of S3 in Server CE and Server Pro. A [separate guide](https://docs.overleaf.com/on-premises/maintenance/s3-migration) can be found on migrating existing data to S3 compatible storage.
{% endhint %}
