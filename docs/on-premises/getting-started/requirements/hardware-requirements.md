...
{% hint style="warning" %}
If you are considering using a NFS (Network File System) based file system for your small instance please have a look at this section in the Troubleshooting section: [troubleshooting.md](../../support/troubleshooting.md "mention")
{% endhint %}
