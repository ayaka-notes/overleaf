...
| Maximum size of editable material per project    | **Default:** 7 MB. See [Environment variables](../configuration/overleaf-toolkit/environment-variables.md) for more information about customizing this value.           |
