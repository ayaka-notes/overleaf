...
To avoid any upgrade issues we recommend consulting our [Release notes](https://docs.overleaf.com/on-premises/release-notes) prior to performing any upgrades as certain versions may require additional steps. Such as, making manual changes to the Toolkit, upgrading databases or running migration scripts.
