...
*   **Project files and History files**
    ...
    * For small single instances we support either a local file system (which could be backed by a local SSD, NFS or EBS) or a [S3 compatible data storage system](../configuration/overleaf-toolkit/s3.md).
